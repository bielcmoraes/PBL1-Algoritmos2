...
class GerenciaProdutoTest {
	...
	void EditandoProdutoNaoCadastrado() {
		...
		info[1] = "9.99"; 
		info[2] = "10/10/2022";
		assertFalse(gerenciaProduto.editarProduto(bancoDeDados.getListaProdutos(), "999", info), "Editando 1 produto n�o cadastrado");
	}
	...
	void ExcluindoProdutoNaoCadastrado() {
		...
		assertFalse(gerenciaProduto.excluirProduto(bancoDeDados.getListaProdutos(), bancoDeDados.getListaIds(),"999"), "Excluindo 1 produto n�o cadastrado");
	}
	...
	void ExcluindoProdutoCadastradoEmListaComDoisProdutosCadastrados() {
		...
		assertEquals("Massa", bancoDeDados.getListaProdutos().get(0).getNome(), "Exclus�o do produto correto");
	}
}
